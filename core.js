...
(function (exports) {
  ...
  // Стандартная иконка «поделиться» (три соединённых узла — как в Android/
  // Material), вместо непонятного 🔗. Инлайн-SVG в тон теме (stroke=currentColor).
  function shareIcon(size) {
    const s = size || 16;
    return `<svg class="share-ico" viewBox="0 0 24 24" width="${s}" height="${s}" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.6" y1="13.5" x2="15.4" y2="17.5"/><line x1="15.4" y1="6.5" x2="8.6" y2="10.5"/></svg>`;
  }
