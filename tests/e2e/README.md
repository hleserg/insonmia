...
node tests/e2e/filters.js       # фильтры ценз/локация: модалка-воронка, откат черновика, И-день, пустое+сброс, память сессии, «рядом»=ценз, развилка экспорта (N/700+), контраст чипов ≥4.5:1
```
